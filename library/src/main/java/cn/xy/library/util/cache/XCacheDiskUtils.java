...
import cn.xy.library.constant.CacheConstants;
 ...
 */
public final class XCacheDiskUtils implements CacheConstants {
    ...
    private static final Map<String, XCacheDiskUtils> CACHE_MAP = new HashMap<>();
    ...
    /**
     * Return the single {@link XCacheDiskUtils} instance.
     ...
     * @return the single {@link XCacheDiskUtils} instance
     */
    public static XCacheDiskUtils getInstance() {
     ...
     * @return the single {@link XCacheDiskUtils} instance
     */
    public static XCacheDiskUtils getInstance(final String cacheName) {
     ...
     * @return the single {@link XCacheDiskUtils} instance
     */
    public static XCacheDiskUtils getInstance(final long maxSize, final int maxCount) {
     ...
     * @return the single {@link XCacheDiskUtils} instance
     */
    public static XCacheDiskUtils getInstance(String cacheName, final long maxSize, final int maxCount) {
        if (XString.isSpace(cacheName)) cacheName = "cacheUtils";
        File file = new File(XApp.getApp().getCacheDir(), cacheName);
     ...
     * @return the single {@link XCacheDiskUtils} instance
     */
    public static XCacheDiskUtils getInstance(@NonNull final File cacheDir) {
    ...
    public static XCacheDiskUtils getInstance(@NonNull final File cacheDir,
        ...
        XCacheDiskUtils cache = CACHE_MAP.get(cacheKey);
        if (cache == null) {
            synchronized (XCacheDiskUtils.class) {
                cache = CACHE_MAP.get(cacheKey);
                if (cache == null) {
                    cache = new XCacheDiskUtils(cacheKey, cacheDir, maxSize, maxCount);
    ...
    private XCacheDiskUtils(final String cacheKey,
                            final File cacheDir,
                            final long maxSize,
                            final int maxCount) {
        mCacheKey = cacheKey;
    ...
    private DiskCacheManager getDiskCacheManager() {
        if (mCacheDir.exists()) {
            ...
            if (mCacheDir.mkdirs()) {
                ...
                Log.e("XCacheDiskUtils", "can't make dirs in " + mCacheDir.getAbsolutePath());
            }
        }
    ...
    static boolean writeFileFromBytes(final File file,
                                      final byte[] bytes) {
        return XFileIO.writeFileFromBytesByChannel(file, bytes, true);
    }
    ...
    private byte[] realGetBytes(@NonNull final String key, final byte[] defaultValue) {
        ...
        byte[] data = XFileIO.readFile2BytesByChannel(file);
    ...
    public void put(@NonNull final String key, final String value, final int saveTime) {
        realPutBytes(TYPE_STRING + key, XConvert.string2Bytes(value), saveTime);
    }
    ...
    public String getString(@NonNull final String key, final String defaultValue) {
        ...
        return XConvert.bytes2String(bytes);
    }
    ...
    public void put(@NonNull final String key,
                    ...
                    final int saveTime) {
        realPutBytes(TYPE_JSON_OBJECT + key, XConvert.jsonObject2Bytes(value), saveTime);
    }
    ...
    public JSONObject getJSONObject(@NonNull final String key, final JSONObject defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return XConvert.bytes2JSONObject(bytes);
    }
    ...
    public void put(@NonNull final String key, final JSONArray value, final int saveTime) {
        realPutBytes(TYPE_JSON_ARRAY + key, XConvert.jsonArray2Bytes(value), saveTime);
    }
    ...
    public JSONArray getJSONArray(@NonNull final String key, final JSONArray defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return XConvert.bytes2JSONArray(bytes);
    }
    ...
    public void put(@NonNull final String key, final Bitmap value, final int saveTime) {
        realPutBytes(TYPE_BITMAP + key, XConvert.bitmap2Bytes(value), saveTime);
    }
    ...
    public Bitmap getBitmap(@NonNull final String key, final Bitmap defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return XConvert.bytes2Bitmap(bytes);
    }
    ...
    public void put(@NonNull final String key, final Drawable value, final int saveTime) {
        realPutBytes(TYPE_DRAWABLE + key, XConvert.drawable2Bytes(value), saveTime);
    }
    ...
    public Drawable getDrawable(@NonNull final String key, final Drawable defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return XConvert.bytes2Drawable(bytes);
    }
    ...
    public void put(@NonNull final String key, final Parcelable value, final int saveTime) {
        realPutBytes(TYPE_PARCELABLE + key, XConvert.parcelable2Bytes(value), saveTime);
    }
    ...
    public <T> T getParcelable(@NonNull final String key,
        ...
        if (bytes == null) return defaultValue;
        return XConvert.bytes2Parcelable(bytes, creator);
    }
    ...
    public void put(@NonNull final String key, final Serializable value, final int saveTime) {
        realPutBytes(TYPE_SERIALIZABLE + key, XConvert.serializable2Bytes(value), saveTime);
    }
    ...
    public Object getSerializable(@NonNull final String key, final Object defaultValue) {
        ...
        if (bytes == null) return defaultValue;
        return XConvert.bytes2Object(bytes);
    }
