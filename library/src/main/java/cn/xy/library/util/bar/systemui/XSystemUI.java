package cn.xy.library.util.bar.systemui;
 ...
 * <pre>
 *     author: Xy
 *     time  : 23:16 2020/12/12
 *     desc  : utils about SystemUi
 * </pre>
 */
...
public class XSystemUI {
    ...
    public static int getStatusBarHeight() {
        Resources resources = XApp.getApp().getResources();
...
//    }
    ...
    private static Activity getActivityByView(@NonNull final View view) {
        ...
        XLog.e("XSystemUI", "the view's Context is not an Activity.");
        return null;
    }
}
