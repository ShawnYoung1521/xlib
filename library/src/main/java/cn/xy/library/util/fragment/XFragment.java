package cn.xy.library.util.fragment;
...
public final class XFragment {
    ...
    public static void addFragmentToBackStack(FragmentManager fm,Fragment fragment,int id){
        FragmentTransaction ft = fm.beginTransaction();
    ...
    public static void popFragmentFromBackStack(FragmentManager fm){
        fm.popBackStack();
