 ...
 * clear                     : 清除所有缓存
 */
public final class XCacheDoubleStaticUtils {

    private static XCacheDoubleUtils sDefaultCacheDoubleUtils;

    /**
     * Set the default instance of {@link XCacheDoubleUtils}.
     *
     * @param cacheDoubleUtils The default instance of {@link XCacheDoubleUtils}.
     */
    public static void setDefaultCacheDoubleUtils(final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param key              The key of cache.
     * @param value            The value of cache.
     * @param cacheDoubleUtils The instance of {@link XCacheDoubleUtils}.
     */
    public static void put(@NonNull final String key,
                           final byte[] value,
                           @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bytes if cache exists or null otherwise
     */
    public static byte[] getBytes(@NonNull final String key, @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the string value if cache exists or null otherwise
     */
    public static String getString(@NonNull final String key, @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the JSONArray if cache exists or null otherwise
     */
    public static JSONArray getJSONArray(@NonNull final String key, @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Bitmap getBitmap(@NonNull final String key, @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the drawable if cache exists or null otherwise
     */
    public static Drawable getDrawable(@NonNull final String key, @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Object getSerializable(@NonNull final String key, @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the size of cache in disk
     */
    public static long getCacheDiskSize(@NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the count of cache in disk
     */
    public static int getCacheDiskCount(@NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the count of cache in memory.
     */
    public static int getCacheMemoryCount(@NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param cacheDoubleUtils The instance of {@link XCacheDoubleUtils}.
     */
    public static void remove(@NonNull String key, @NonNull final XCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param cacheDoubleUtils The instance of {@link XCacheDoubleUtils}.
     */
    public static void clear(@NonNull final XCacheDoubleUtils cacheDoubleUtils) {
        cacheDoubleUtils.clear();
    }

    private static XCacheDoubleUtils getDefaultCacheDoubleUtils() {
        return sDefaultCacheDoubleUtils != null ? sDefaultCacheDoubleUtils : XCacheDoubleUtils.getInstance();
    }
}
