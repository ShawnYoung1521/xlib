package cn.xy.library.util.array;
...
public class XArray {
     ...
     *
     * <pre>
     * XArray.realAdd(null, null)      = [null]
     * XArray.realAdd(null, "a")       = ["a"]
     * XArray.realAdd(["a"], null)     = ["a", null]
     * XArray.realAdd(["a"], "b")      = ["a", "b"]
     * XArray.realAdd(["a", "b"], "c") = ["a", "b", "c"]
     * </pre>
     *
     ...
     *
     * <pre>
     * XArray.add(null, null)     = null
     * XArray.add(array1, null)   = copy of array1
     * XArray.add(null, array2)   = copy of array2
     * XArray.add([], [])         = []
     * XArray.add([null], [null]) = [null, null]
     * XArray.add(["a", "b", "c"], ["1", "2", "3"]) = ["a", "b", "c", "1", "2", "3"]
     * </pre>
     *
     ...
     *
     * <pre>
     * XArray.add(null, 0, null)      = [null]
     * XArray.add(null, 0, "a")       = ["a"]
     * XArray.add(["a"], 1, null)     = ["a", null]
     * XArray.add(["a"], 1, "b")      = ["a", "b"]
     * XArray.add(["a", "b"], 3, "c") = ["a", "b", "c"]
     * </pre>
     *
     ...
     * <pre>
     * XArray.remove(["a"], 0)           = []
     * XArray.remove(["a", "b"], 0)      = ["b"]
     * XArray.remove(["a", "b"], 1)      = ["a"]
     * XArray.remove(["a", "b", "c"], 1) = ["a", "c"]
     * </pre>
     *
     ...
     *
     * <pre>
     * XArray.removeElement(null, "a")            = null
     * XArray.removeElement([], "a")              = []
     * XArray.removeElement(["a"], "b")           = ["a"]
     * XArray.removeElement(["a", "b"], "a")      = ["b"]
     * XArray.removeElement(["a", "b", "a"], "a") = ["b", "a"]
     * </pre>
     *
