package cn.xy.library.util.spannable;
...
public final class XSpanned {
    ...
    public static XSpanned with(final TextView textView) {
        return new XSpanned(textView);
    }
    ...
    private XSpanned(TextView textView) {
        this();
        mTextView = textView;
    }
     ...
     *             </ul>
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setBullet(@ColorInt final int color,
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setFontProportion(final float proportion) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setFontXProportion(final float proportion) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setStrikethrough() {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setSuperscript() {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setClickSpan(@ColorInt final int color,
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setUrl(@NonNull final String url) {
        if (mTextView != null && mTextView.getMovementMethod() == null) {
            mTextView.setMovementMethod(LinkMovementMethod.getInstance());
        }
        this.url = url;
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                            final Blur style) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                              final float dx,
                              final float dy,
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link XSpanned} instance
     */
    public XSpanned appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            LogUtils.e(fm, sfm);
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(XApp.getApp().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            XApp.getApp().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(XApp.getApp().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(XApp.getApp(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
