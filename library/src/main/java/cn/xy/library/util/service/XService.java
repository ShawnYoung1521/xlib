package cn.xy.library.util.service;
 ...
 * <pre>
 *     author: Xy
 *     time  : 15:29 2020/12/11
 *     desc  : XApp about service
 * </pre>
 */
/**
...
public final class XService {
        ...
        public static void startService(@NonNull final Class<?> cls) {
            startService(new Intent(XApp.getApp(), cls));
        }
         ...
         * @param className The name of class.
         */
        public static void startForegroundService(@NonNull final String className) {
            try {
                startForegroundService(Class.forName(className));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
         ...
         * @param cls The service class.
         */
        public static void startForegroundService(@NonNull final Class<?> cls) {
            startForegroundService(new Intent(XApp.getApp(), cls));
        }
        ...
        public static boolean stopService(@NonNull final Class<?> cls) {
            return stopService(new Intent(XApp.getApp(), cls));
        }
        ...
        public static void bindService(@NonNull final Class<?> cls,
                                       @NonNull final ServiceConnection conn,
                                       final int flags) {
            bindService(new Intent(XApp.getApp(), cls), conn, flags);
        }
        ...
        public static void bindService(@NonNull final Intent intent,
                                       ...
                                       final int flags) {
            try {
                XApp.getApp().bindService(intent, conn, flags);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        public static void unbindService(@NonNull final ServiceConnection conn) {
            XApp.getApp().unbindService(conn);
        }
