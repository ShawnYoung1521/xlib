package cn.xy.library.util.shell;
...
public final class ShellUtils {
     ...
     * @return the task
     */
    public static XApp.Task<CommandResult> execCmdAsync(final String command,
                                                        final boolean isRooted,
                                                        final XApp.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static XApp.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                        final boolean isRooted,
                                                        final XApp.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static XApp.Task<CommandResult> execCmdAsync(final String[] commands,
                                                        final boolean isRooted,
                                                        final XApp.Consumer<CommandResult> consumer) {
    ...
    public static XApp.Task<CommandResult> execCmdAsync(final String[] commands,
                                                        final boolean isRooted,
                                                        final boolean isNeedResultMsg,
                                                        @NonNull final XApp.Consumer<CommandResult> consumer) {
        return XNetwork.doAsync(new XApp.Task<CommandResult>(consumer) {
            @Override
