package cn.xy.library.util.convert;
 ...
 * string2color layer2color                : 颜色的转换
 */
public final class XConvert {
    ...
    public static byte[] hexString2Bytes(String hexString) {
        if (XString.isSpace(hexString)) return new byte[0];
    ...
    public static Bitmap bytes2Bitmap(final byte[] bytes) {
        return XImage.bytes2Bitmap(bytes);
    }
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap) {
        return XImage.bitmap2Bytes(bitmap);
    }
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap, final Bitmap.CompressFormat format, int quality) {
        return XImage.bitmap2Bytes(bitmap, format, quality);
    }
    ...
    public static Drawable bytes2Drawable(final byte[] bytes) {
        return XImage.bytes2Drawable(bytes);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable) {
        return XImage.drawable2Bytes(drawable);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable, final Bitmap.CompressFormat format, int quality) {
        return XImage.drawable2Bytes(drawable, format, quality);
    }
...
//        return XTime.millis2FitTimeSpan(millis, precision);
//    }
    ...
    public static Bitmap drawable2Bitmap(final Drawable drawable) {
        return XImage.drawable2Bitmap(drawable);
    }
    ...
    public static Drawable bitmap2Drawable(final Bitmap bitmap) {
        return XImage.bitmap2Drawable(bitmap);
    }
    /**
     * View to bitmap.
     */
    public static Bitmap view2Bitmap(final View view) {
        return XImage.view2Bitmap(view);
    }
    ...
    public static int px2sp(final float pxValue) {
        return XSize.px2sp(pxValue);
    }

    private static String getSafeCharset(String charsetName) {
        String cn = charsetName;
        if (XString.isSpace(charsetName) || !Charset.isSupported(charsetName)) {
            cn = "UTF-8";
        }
        return cn;
    }
     ...
     * @return Color
     */
    public static int string2color(String colorstring){
     ...
     * @return color
     */
    public static int layer2color(int alpha,int red,int green,int blue){
